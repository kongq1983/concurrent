...
public class ParkUnParkDeadLockDemo {

    public static void main(String[] args) throws Exception{
        // 能正常演示
        new ParkUnParkDeadLockDemo().parkUnPark();
...
//                synchronized (WaitNotifyDemo.class) {
                ...
                try {
                    ...
                    synchronized (this) {
                        System.out.println("=============before===LockSupport.park===========");
                        LockSupport.park();
                        System.out.println("=============after===LockSupport.park===========");
                    }
